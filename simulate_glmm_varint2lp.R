...
colnames(glmm.fixeffs)        <- c('alpha0', 'beta0', 'beta1', "gamma")
colnames(glmm.p)              <- c('alpha0', 'beta0', 'beta1', "gamma")
colnames(glm.coefs)           <- c('alpha0', 'beta0', 'beta1', "gamma")
colnames(glm.p)               <- c('alpha0', 'beta0', 'beta1', "gamma")
colnames(glm.f.coefs)         <- c('alpha0', 'beta0', 'beta1', "gamma", paste0("group", char.seq(2, J)), paste0("x_gamma:group", char.seq(2, J)))
colnames(glm.f.p)             <- c('alpha0', 'beta0', 'beta1', "gamma", paste0("group", char.seq(2, J)), paste0("x_gamma:group", char.seq(2, J)))
...
for (i in 1:nsim) {
  ...
  .names <- c("alpha0", "beta0", "beta1", "gamma", names(coef(summary(.run$glm.f))[,4])[-c(1:4)])
...
plot.fixeffs(glmm.fixeffs, c("alpha0", "beta0", "beta1", "gamma"), c(alpha0, beta0, beta1, gamma),
